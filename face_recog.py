...
for face in faces:
    ...
    crop_face = img2[fc[1]:fc[1]+fc[3], fc[0]:fc[0]+fc[2]]
    features = facerecognizer.feature(crop_face)
...
print("------------------------------------------")
print("Face detection time: ", faces_detect_time)
print("Face recognition time: ", faces_recog_time)
print("******************************************")
print("Target faces (sec): ", target_faces)
print("Faces Recognized (sec): ", feat_match_cnt)
print("------------------------------------------")
